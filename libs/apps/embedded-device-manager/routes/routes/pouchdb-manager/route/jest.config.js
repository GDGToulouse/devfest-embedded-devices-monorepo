module.exports = {
	name: 'apps-embedded-device-manager-routes-routes-pouchdb-manager-route',
	preset: '../../../../../../../jest.config.js',
	coverageDirectory: '../../../../../../../coverage/libs/apps/embedded-device-manager/routes/routes/pouchdb-manager/route',
